...
Open access (OA) refers to having content, such as journal articles or datasets, available for public access. Most journals typically charge an Article Processing Charge (APC) for a published journal article to be open access. The University of Adelaide has Read and Publish agreements with certain journals to waive that APC (see [this tool](https://apps.library.adelaide.edu.au/readpublishsearch/) for which journals. Use 'cognitive psychology' as a keyword.). Some relevant journals are:
