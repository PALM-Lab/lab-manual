...
> _I hope to be a supportive supervisor for all PALM Lab members, fostering a working relationship that lasts throughout their journey in academia and science. I like to think of the mentor role as being a coach - to me, it gives the sense that the mentee has the agency in what they can achieve!_
>
...
* Disclosing or reporting an incident of unacceptable behaviour to the [Integrity Unit](https://www.adelaide.edu.au/safer-campus-community/reporting-options).
* The university's [Counselling Support](https://www.adelaide.edu.au/counselling/) provides free, short-term help with issues affecting student life.
* Contacting and seeking advice from the Research Coordinator ([Dr Rachel Stephens](https://researchers.adelaide.edu.au/profile/rachel.stephens)), the Research Integrity Advisor ([Professor Carolyn Semmler](https://researchers.adelaide.edu.au/profile/carolyn.semmler)), and/or the Postgraduate Coordinator ([Associate Professor Diana Dorstyn](https://www.adelaide.edu.au/directory/diana.dorstyn)).

## Student wellbeing

The University of Adelaide is highly committed to supporting its students and their wellbeing. The [Hub Central](https://www.adelaide.edu.au/student-hubs/hub-central) located on Level 3 of the North Terrace Campus, underneath the Hughes Building, is a 24/7 place where students can seek advice with all things. The staff will be more than willing to direct you to where you can receive relevant support, if they can't provide it themselves.